        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Row = table.Column<byte>(type: "tinyint unsigned", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BooksCopies", x => new { x.BookId, x.CopyNumber });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_BooksCopies_Bookshelfs_BookshelfId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Loans", x => new { x.UserId, x.BookId, x.CopyNumber });
                    table.ForeignKey(
                        name: "FK_Loans_BooksCopies_BookId_CopyNumber",
                        columns: x => new { x.BookId, x.CopyNumber },
                        principalTable: "BooksCopies",
                        principalColumns: new[] { "BookId", "CopyNumber" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BooksCopies_BookshelfId",
                table: "BooksCopies",
                column: "BookshelfId");

            migrationBuilder.CreateIndex(
                name: "IX_Loans_BookId_CopyNumber",
                table: "Loans",
