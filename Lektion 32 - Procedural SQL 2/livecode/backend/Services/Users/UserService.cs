...
namespace Solution.Services.Users
{
    public class UsersService
    {
        ...
        public void LoanBook(LoanRequestDto loanDto)
        {
            ...
            try
            {
                _loansRepo.CreateLoan(loanModel);
        ...
        public List<LoanRespondDto> GetLoanByUser(int userId)
        {
            List<UserLoansViewModel> loans = _loansRepo.GetLoanById(userId);
            List<LoanRespondDto> loanRespond = new List<LoanRespondDto>();

            foreach (UserLoansViewModel loan in loans)
            {
                loanRespond.Add
                (
                    new LoanRespondDto
